use bevy::{
    app::{App, Startup, Update}, asset::Assets, color::{Color, Srgba}, diagnostic::{DiagnosticsStore, FrameTimeDiagnosticsPlugin}, light::AmbientLight, math::Vec3, pbr::{ MeshMaterial3d, StandardMaterial}, prelude::{
