...
use bevy::{
    app::{App, Startup, Update}, asset::{AssetServer, Assets}, color::{Color, Srgba}, ecs::{event::EventReader, system::Query}, input::keyboard::{KeyCode, KeyboardInput}, light::AmbientLight, math::{Vec2, Vec3}, pbr::{MeshMaterial3d, StandardMaterial}, prelude::{
